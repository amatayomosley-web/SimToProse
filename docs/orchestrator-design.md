...
|---|---|---|---|
| ASK-WORLD | "what does she know about the fire?" | query scoped to **her vault**, not world-truth | ANSWER |
| ASK-FEASIBLE | "can she reach the capital by Thursday?" | state + clock + law | VERDICT |
| INTENT | "I want a scene where she tells Imogen" | legality, current state, her standing wants | PROPOSAL, or VERDICT(deny) |
