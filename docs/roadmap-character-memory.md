...
### Problem Statement
Characters currently track how they feel about others (`trust`, `affinity`, `respect`, `debt`), but cannot represent asymmetric knowledge (e.g. *"I know the letter was opened, and I know my sister doesn't know"*). Dramatic irony and deliberate deception depend entirely on prompt coincidence rather than mechanical support.
