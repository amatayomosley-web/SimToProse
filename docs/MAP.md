...
**Why this file exists.** `docs/` holds 126 design docs, `src/engine/` 68 modules,
`tests/` 117 suites. Nobody — human or agent — can hold that in their head, and reading it all every
...
## src/engine/ — 68 modules (normative for what IS)
...
## tests/ — 117 suites (each is a PROOF of the gate it names)
