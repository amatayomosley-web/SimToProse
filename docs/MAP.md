...
`tests/` 121 suites. Nobody — human or agent — can hold that in their head, and reading it all every
...
| `replies` | a model's reply, read into a frozen record: the actor's first (the seats, keeper and composer follow). |
...
## tests/ — 121 suites (each is a PROOF of the gate it names)
