...
|---|---|---|---|---|
| A1 | every suite green | `python tests/run_all.py` | `0 failed` — the suite count is DISCOVERED, so do not pin it here (this row said `43 passed` until 2026-09-06, by which time the tree held 76) | **76/76, 2026-09-06** |
