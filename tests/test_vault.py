...
CHAR_ENGINE = {
    ...
    "current": {
        "affect": {p: v for p, v in zip(PRIMARIES, (0.6, 0.4, 0.2, 0.2, 0.5, 0.3, 0.35))},
...
def main():
    ...
    try:
        for t in (test_parse_note, test_load_book_validates, test_links_are_live_triggers, test_fail_loud):
            t(tmp)
    finally:
