...
def test_contradiction_detection():
    ...
    check("alive-dead", acquisition.detect_contradiction("Marisol is alive in the north", "Marisol is dead"))
    check("loyal-traitor", acquisition.detect_contradiction("Maren is a traitor to the watch", "Maren is loyal"))
    check("negation-is-not", acquisition.detect_contradiction("The parking permit is not valid", "The parking permit is valid"))
    check("negation-has-no", acquisition.detect_contradiction("The chest has no gold", "The chest has gold"))
    check("unrelated-no-contradiction", not acquisition.detect_contradiction("Marisol plays the cello", "Marisol carries a stopwatch"))
...
def test_explicit_supersession():
    ...
    old_b = {"claim": "The well in the square runs sweet", "confidence": 0.9,
             "provenance": "lived", "believed_value": True, "links": ["square_well"]}
    char = {"fixed": {"name": "Kael"}, "baseline": {}, "current": {"vault": [old_b]}}
    old_bid = belief_id(old_b)

    applied = {"target": "square_well"}
    tags = {"summary": "The well in the square has turned brackish since the storm", "durability": "durable",
            "confidence": 0.95, "supersedes": "The well in the square runs sweet"}
    ...
    tags_loose = {"summary": "The well in the square has turned brackish since the storm", "durability": "durable",
                  "confidence": 0.95, "supersedes": "well"}
    ...
    tags_by_id = {"summary": "The well in the square has turned brackish since the storm", "durability": "durable",
