...
# CompoundError left with compounds.py when the primitive set was retired 2026-09-08
# (staging/src/engine/compounds.py).
_ALL = (BibleError, BookError, CrossBookDbError, CitationError,
