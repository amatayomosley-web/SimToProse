...
Proves:
  ...
  2. Multi-hop associative chain (the shopkeeper sigil: sigil -> casks -> maren -> veil)
...
def test_shopkeeper_sigil_rested():
    ...
    b1 = {
        "claim": "Saw the coiled serpent mark burned on wine casks 15 years ago",
        "confidence": 0.7,
        "provenance": "lived",
        "links": ["coiled_serpent", "wine_casks"],
    }
    b2 = {
        "claim": "The wine casks were part of Maren the carter's runs",
        "confidence": 0.8,
        "provenance": "lived",
        "links": ["wine_casks", "maren"],
    }
    b3 = {
