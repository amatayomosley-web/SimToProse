...
exactly like the built-in DEFAULT_SCENE — so a director can author varied scenes for a multi-scene book.
...
def main():
    ...
    good = {"at": {"day": 1, "time": "09:00"}, "situation": "Two healers rest by the fire.",
            "subject": [None, None],
    ...
    for bad, label in (({"cast": [{"id": "x", "drive": "y"}]}, "no-situation"),
                       ({"at": {"day": 1, "time": "09:00"}, "situation": "x"}, "no-cast"),
                       ({"situation": "x", "cast": [{"id": "x", "drive": "y"}]}, "no-at-the-clock-is-required"),
                       ({"at": {"day": 1, "time": "09:00"}, "situation": "x", "cast": [{"id": "x", "drive": "y"}],
                         "elapsed": 3}, "elapsed-is-derived-and-refused"),
                       ({"at": {"day": 1, "time": "09:00"}, "situation": "x", "cast": [{"id": "x"}]}, "cast-missing-drive")):
        try:
