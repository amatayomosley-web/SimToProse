...
from .consolidation import CATALOG, SYSTEM_TYPES as _SYSTEM_TYPES
...
# _SYSTEM_TYPES derived from consolidation.SYSTEM_TYPES 2026-09-19 (CLAUDE.md's seven-duplicates
# rule) — was a second hand-copied tuple, `("turn-skipped", "correction")`, byte-identical to
# `consolidation.py:359`. No import cycle: consolidation.py imports only `.state` and `.errors`.
